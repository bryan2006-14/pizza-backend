# ── Agregar estas líneas a panel_admin/urls.py ──────────────────────────────
# Importar las vistas nuevas al inicio del archivo:
#
#   from .views_cocina import vista_cocina, api_pedidos_cocina, api_cambiar_estado_pedido
#
# Luego agregar dentro de urlpatterns:

"""
    # ==================== COCINA ====================
    path('cocina/',                               vista_cocina,               name='cocina'),
    path('cocina/pedidos/',                       api_pedidos_cocina,         name='api_pedidos_cocina'),
    path('cocina/pedidos/<int:pk>/estado/',       api_cambiar_estado_pedido,  name='api_cambiar_estado'),
"""

# ── urls.py completo actualizado ─────────────────────────────────────────────
